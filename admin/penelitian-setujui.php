...
$pesan = "Yth. " . stripslashes($nama) . "
						...
						<br/>
						<br/>
						<a href='" . $actual_link . "/mahasiswa/penelitian-cetak.php?nodata=" . $nodata . "' style=' background-color: #0000FF;border: none;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;'>Cetak Surat " . $surat . "</a> 
						<br/>
						<br/>
