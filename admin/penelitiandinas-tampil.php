            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pengajuan Surat Ijin Penelitian Dinas</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- Content Column -->
                        <div class="col-lg-12 mb-4">
                            ...
                            $qsurat = mysqli_query($conn, "SELECT * FROM penelitiandinas WHERE no='$nosurat'");
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="user" action="penelitiandinas-setujui.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user" name="tempatpenelitian" id="tempatpenelitian" value="<?= $tempatpenelitian; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Lokasi Penelitian</label>
                                            <textarea class="form-control form-control-user" name="lokasipenelitian" id="lokasipenelitian" rows="4"><?= $lokasipenelitian; ?></textarea>
                                        </div>
    ...
    <div class="modal fade" id="tolakModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="penelitiandinas-tolak.php" method="POST">
