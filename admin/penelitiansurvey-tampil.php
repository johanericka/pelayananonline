                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            <!-- ambil data -->
                            <?php
                            $qsurat = mysqli_query($conn, "SELECT * FROM penelitiansurvey WHERE no='$nosurat'");
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                    <form class="user" action="penelitiansurvey-setujui.php" method="POST">
    ...
    <div class="modal fade" id="tolakModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="penelitiansurvey-tolak.php" method="POST">
