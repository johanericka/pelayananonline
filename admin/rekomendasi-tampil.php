                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            <!-- cari data user -->
                            <?php
                            $quser = mysqli_query($conn, "SELECT * FROM rekomendasi WHERE nodata='$nodata'");
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jenissurat" value="Surat Rekomendasi" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label>Keperluan</label>
                                        <input type="text" class="form-control" name="keperluan" value="<?= $keperluan; ?>" readonly>
                                    </div>
                                    <form class="user" action="rekomendasi-setujui.php" method="POST">
                                        <hr>
    ...
    <div class="modal fade" id="tolakModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="rekomendasi-tolak.php" method="POST">
