                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <?php
                            if (isset($nosurat)) {
                                $qsurat = mysqli_query($conn, "SELECT * FROM validasi WHERE no='$nosurat'");
                            ...
                            ?>
                            <div class="card-body">
                                <form class="user" action="validator-setujui.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="validasi" id="validasi" value="<?= $validasi; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Judul </label>
                                        <input type="text" class="form-control form-control-user" name="judul" id="judul" value="<?= $judul; ?>">
                                    </div>
                                    <div class="form-group">
                                        <?php
                                        if ($jenjang == 'S1') {
                                        ?>
                                            ...
                                            <input type="text" class="form-control form-control-user" name="dosen1" id="dosen1" value="<?= $dosen1; ?>">
                                        <?php
                                        } else {
                                        ?>
                                            ...
                                            <input type="text" class="form-control form-control-user" name="dosen2" id="dosen2" value="<?= $dosen2; ?>">
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="validator" id="validator" value="<?= $validator; ?>">
                                    </div>
                                    <hr>
                                    <?php
                                    if ($verifikasi == 2) {
        ...
        <div class="modal fade" id="tolakModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="validator-tolak.php" method="POST">
