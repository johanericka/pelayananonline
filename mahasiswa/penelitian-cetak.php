...
$namafile = $nim . "-penelitian-" . $nodata;
...
<table table style="width:80%; margin-left:auto;margin-right:auto;" cellspacing="0" border="0">
	<tbody>
		...
		<tr>
			<td colspan="6" style="text-align:justify">Dalam rangka menyelesaikan tugas akhir kuliah (skripsi), kami mohon diberikan izin penelitian di lembaga yang Bapak / Ibu pimpin kepada mahasiswa : </td>
		</tr>
		<tr>
			<td width="5%"> </td>
			<td width="20%">Nama</td>
		...
		<tr>
			<td colspan="4" style="text-align:justify">Demikian, atas perkenannya kami sampaikan terima kasih. </td>
		</tr>
		<tr>
...
<?php
$qpejabat = mysqli_query($conn, "SELECT * FROM jenissurat WHERE namasurat='Izin Penelitian'");
