            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Surat Izin Penelitian Dinas</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- Content Column -->
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Keperluan Skripsi / Tesis / Desertasi tertuju ke dinas pemerintah</h6>
                                </div>
                                <div class="card-body">
                                    <form class="user" action="penelitiandinas-simpan.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user" name="tempatpenelitian" id="tempatpenelitian" rows="4" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Lokasi Penelitian</label>
                                            <textarea class="form-control form-control-user" name="lokasipenelitian" id="lokasipenelitian" rows="4" required></textarea>
                                        </div>
