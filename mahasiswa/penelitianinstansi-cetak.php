...
$qsurat = mysqli_query($conn, "SELECT * FROM penelitianinstansi WHERE no='$nodata'");
...
<table table style="width:90%; margin-left:auto;margin-right:auto;" cellspacing="0" border="0">
	<tbody>
		...
		<tr>
			<td colspan="6" style="text-align:justify">Dengan hormat, dalam rangka menyelesaikan tugas akhir berupa penyusunan <?= $keperluan; ?> mahasiswa Fakultas Ilmu Tarbiyah dan Keguruan Universitas Islam Negeri Maulana Malik Ibrahim Malang, kami mohon dengan hormat agar mahasiswa berikut: </td>
		</tr>
		<tr>
			<td width="5%"> </td>
			<td width="20%">Nama</td>
		...
		<tr>
			<td colspan="6" style="text-align:justify">diberi izin untuk melakukan penelitian di lembaga/instansi yang menjadi wewenang Bapak/Ibu.</td>
		</tr>
		<tr>
			<td colspan="6" style="text-align:justify">Demikian, atas perkenan dan kerjasama Bapak/Ibu yang baik disampaikan terima kasih. </td>
		</tr>
		<tr>
