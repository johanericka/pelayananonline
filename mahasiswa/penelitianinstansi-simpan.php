...
*/
$qsimpan = mysqli_query($conn, "INSERT INTO penelitianinstansi (tglpengajuan,prodi,jenjang,nim,nama,nohp,email,semester,tahunakademik,keperluan,judul,namainstansi,alamatinstansi,tglmulai,tglselesai,verifikator) 
								VALUES ('$tglpengajuan','$prodi','$jenjang','$nim','$nama','$nohp','$email','$semester','$tahunakademik','$keperluan','$judulpenelitian','$tujuansurat','$alamatsurat','$penelitianmulai','$penelitianselesai','$verifikator')");
...
while ($dadminfak = mysqli_fetch_array($qadminfak)) {
	...
	$pesan = "Yth. " . $namaadmin . "
						...
						<br/>
						Terdapat Pengajuan <b>Surat Penelitian Instansi</b> atas nama " . $nama . ".
						<br/>
...
$pesan = "Yth. " . $nama . "
						...
						Assalamualaikum Wr. Wb.
						<br/>
						Pengajuan <b>Surat Penelitian Instansi</b> anda sedang menunggu verifikasi dari Bagian Akademik.
						<br/>
						Akan ada email pemberitahuan selanjutnya apabila pengajuan <b>Surat Penelitian Instansi</b> anda telah di verifikasi.
						<br/>
