            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Formulir Surat Pengantar Magang</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- Content Column -->
                                ...
                                <div class="card-body">
                                    <form class="user" action="daftar-simpan.php" method="POST">
                                        ...
                                        <select class="browser-default custom-select" name="keperluan" id="keperluan">
                                            <option value="Magang 1" selected>Magang 1</option>
                                            <option value="Magang 2">Magang 2</option>
                                            <option value="Lain">Lain - Lain</option>
                                        </select>
                                        <div class="form-group">
                                            <label>Keperluan Surat Lain - Lain</label>
                                            <input type="text" class="form-control form-control-user" name="keperluanlain" id="keperluanlain" placeholder="Isi keterangan surat pengantar Lain - Lain disini">
                                        </div>
                                        <br />
                                        <button type="submit" class="btn btn-success btn-user btn-block"> <i class="fas fa-file-upload"></i><b> Upload Bukti KRS/KHS</b></button>
                                        <hr>
                                    </form>
                                </div>
                            </div>
