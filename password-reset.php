...
if ($jpengguna > 0) {
    ...
    $pesan = "Yth. " . $nama . "
                            ...
                            <br/>
                            <br/>
                            <a href='https://humaniora.uin-malang.ac.id/pelayananonline/password-ubah.php?token=$token' style=' background-color: #0000FF;border: none;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;'>Reset Password</a>
                            <br/>
                            <br/>
                            Atau copy & paste link berikut ini ke web-browser anda apabila tombol diatas tidak berfungsi
                            <br/>
                            https://humaniora.uin-malang.ac.id/pelayananonline/password-ubah.php?token=$token
                            <br/>
                            <br/>
