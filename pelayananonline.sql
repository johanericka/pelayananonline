...
INSERT INTO `dispensasi` (`nodata`, `tglpengajuan`, `prodi`, `nim`, `nama`, `nohp`, `email`, `kegiatan`, `namainstansi`, `tglmulai`, `tglselesai`, `alamatinstansi`, `verifikator`, `verifikasi`, `tglverifikasi`, `keterangan`, `statussurat`) VALUES
	(11, '2021-08-28 17:57:42', 'Bahasa dan Sastra Arab', '11111111', 'Johan Ericka Wahyu Prakasa', '08123456789', 'johanericka@gmail.co', 'Praktek Kerja Lapangan (PKL) / Magang', 'Pengasuh Pondok Putri', '2021-08-28', '2021-08-30', 'Jl. Merjosari No. 123 Malang', '197411012003121004', 1, '2021-08-29 15:47:46', '11/FHm/KM.01.2/08/2021', 1),
...
-- Dumping data for table pelayananonline.email: 1 rows
DELETE FROM `email`;
...
-- Dumping data for table pelayananonline.pengguna: ~5 rows (approximately)
...
INSERT INTO `pengguna` (`no`, `nama`, `nim`, `nohp`, `email`, `prodi`, `user`, `pass`, `plaintext`, `role`, `token`, `status`) VALUES
	...
	(1007, 'markonah', '0123', '0812345678', 'ptisaintek@gmail.com', 'Magister Bahasa dan Sastra Arab', 'markonah', '202cb962ac59075b964b07152d234b70', '123', 'mahasiswa', 'b5220dfec494d359f857704fb5ef0c8e', 0);
...
INSERT INTO `rekomendasi` (`nodata`, `tanggal`, `prodi`, `nim`, `nama`, `notelepon`, `email`, `keperluan`, `verifikator`, `verifikasi`, `tglverifikasi`, `keterangan`, `statussurat`) VALUES
	...
	(3, '2021-08-28 14:41:07', 'Bahasa dan Sastra Arab', '11111111', 'Johan Ericka Wahyu Prakasa', '08123456789', 'johanericka@gmail.com', 'melanjutkan studi di Al-Azhar University Mesir', '197411012003121004', 1, '2021-08-29 15:52:42', 'B-3/FHm/KM.01.3/08/2021', 1),
...
-- Dumping data for table pelayananonline.suket: 8 rows
DELETE FROM `suket`;
