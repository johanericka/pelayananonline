            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Formulir Pengajuan Surat Izin Observasi</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- Content Column -->
                                    ...
                                    <form class="user" method="POST" action="observasiindividu-setujui.php">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                ...
                                                <input type="text" class="form-control form-control-user" name="semester" id="semester" value="<?= $semester; ?>" readonly>
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user" name="namamk" id="namamk" value="<?= $namamk; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Dosen Pengampu Matakuliah</label>
                                            <input type="text" class="form-control form-control-user" name="dosen" id="dosen" value="<?= $dosen; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Instansi Tujuan</label>
                                            <input type="text" class="form-control form-control-user" name="namainstansi" id="namainstansi" value="<?= $namainstansi; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat Instansi Tujuan</label>
                                            <textarea class="form-control form-control-user" name="alamatinstansi" id="alamatinstansi" rows="4" readonly><?= $alamatinstansi; ?>
                                            </textarea>
                                        </div>
                                        <label>Tempat Observasi</label>
                                        <div class="form-group">
                                            <label>Nama Tempat Observasi</label>
                                            <input type="text" class="form-control form-control-user" name="tempatobservasi" id="tempatobservasi" value="<?= $tempatobservasi; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat Tempat Observasi</label>
                                            <textarea class="form-control form-control-user" name="alamatobservasi" id="alamatobservasi" rows="4" readonly><?= $alamatobservasi; ?>
                                            </textarea>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                ...
                                                <input type="text" class="form-control form-control-user" name="tglmulai" id="tglmulai" value="<?= $tglmulai; ?>" readonly>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Tanggal Selesai Observasi</label>
                                                <input type="text" class="form-control form-control-user" name="tglselesai" id="tglselesai" value="<?= $tglselesai; ?>" readonly>
                                            </div>
                                        </div>
                                        <br />
