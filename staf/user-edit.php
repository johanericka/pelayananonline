        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body">
                ...
                <div class="p-5">
                    ...
                    $quser = mysqli_query($conn, "SELECT * FROM staff WHERE no='$nodata'");
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <select class="browser-default custom-select" name="role" id="role">
                                ...
                                ?>
                                    ...
                                    <option value="adminfakultas" selected>Admin Fakultas</option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <a href="user-tampil.php" class="btn btn-primary btn-user btn-block"> <b>Kembali </b></a>
                    <hr>
                </div>
            </div>
        </div>
